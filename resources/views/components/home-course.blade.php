<section class=" w-full md:w-9/12 mx-auto text-center font-roboto mt-8 font-roboto">
    ...
    <div class=" grid grid-cols-1 lg:grid-cols-3 mt-5">
        ...
        <div class=" order-1 lg:order-2 w-2/3 lg:w-full mx-auto">
            <div>
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    viewBox="0 0 200 77" xml:space="preserve" id="kmd-svg">
                        <g style="fill:#21409A;stroke:#21409A;stroke-width:1px">
...
@push('js')
    ...
    <script src="{{ asset('js/logosvganim.js') }}"></script>
@endpush
